<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.master" AutoEventWireup="true"
    CodeFile="GestionMensaje.aspx.cs" Inherits="admin_pages_GestionMensaje" %>
       ...
       <script src="../../includes/js/jquery-ui.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            jQuery(document).ready(function () {
                ...
                //$("#dialogMensaje")[0].title = 'Hola';
                ////} else {
                //   // $("#ui-id-1").html('Hola');
                ////}
                //$("#dialogMensajeTexto").text('Mundo');
            ...
            function onclickMensajeTest() {
                MostrarMensajeTest($('#MainContent_Tabs_tab1_txt_asunto').val(), $('#MainContent_Tabs_tab1_txt_mensaje').val());
            ...
            <asp:Panel ID="pnl_grilla" runat="server">
                ...
                <asp:GridView ID="gv_datos" runat="server" CssClass="grilla" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <%--                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="publicar" runat="server" ImageUrl="~/img/iconos/events.png"
                                    ...
                                    CommandArgument='<%# Bind("tme_codigo") %>' CommandName="Publicar" ToolTip="Publicar">
                                </asp:ImageButton>
                            </ItemTemplate>
                            <ItemStyle Width="20px" HorizontalAlign="center" />
                        </asp:TemplateField>--%>
                        ...
                        <asp:BoundField DataField="tme_fechaToString" HeaderText="Fecha" SortExpression="tme_fechaToString" />
                        <asp:BoundField DataField="est_nombre" HeaderText="Estado" SortExpression="est_nombre" />
                        <asp:BoundField DataField="tme_importanteToString" HeaderText="Importante" SortExpression="tme_importanteToString" />
                ...
                <asp:ObjectDataSource ID="odsMensaje" runat="server" SortParameterName="sortExpression"
                    SelectMethod="GetMensajes" TypeName="SitioBase.clases.AccesoGrilla">
                    <SelectParameters>
                            ...
                            <div class="form_datos" style="width: 100%;">
                             <div class="ele_abm">
                                ...
                                <div class="ele_abm">
                                    ...
                                    <div class="html_editor">
                                        <asp:TextBox ID="txt_asunto" CssClass="text_abm" runat="server" MaxLength="300"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="ele_sep">
                                </div>
                                <div class="ele_abm">
                                    ...
                                    <div class="html_editor">
                                        <asp:TextBox ID="txt_mensaje" CssClass="text_abm_100" runat="server" Height="200px"
                                            TextMode="MultiLine" Width="1200px"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="ele_sep">
                                </div>
                                <table>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <div class="html_editor">
                                                <asp:DropDownList ID="cmbClientes" runat="server" DataSourceID="odsClientes" DataTextField="cli_nombre"
                                                    DataValueField="cli_codigo" Width="300px">
                                                </asp:DropDownList>
                                                <asp:ObjectDataSource ID="odsClientes" runat="server" SelectMethod="RecuperarTodosClientesParaCombo"
                                                    TypeName="FuncionesPersonalizadas">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="pIsTodos" SessionField="GestionMensaje_isNuevo" Type="Boolean" />
                                                    </SelectParameters>
                                                </asp:ObjectDataSource>
                                            </div>
                                        </td>
                                ...
                                <div class="ele_abm">
                                    ...
                                    <div class="html_editor">
                                        <asp:DropDownList ID="cmbEstado" runat="server" Width="300px">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="ele_sep">
