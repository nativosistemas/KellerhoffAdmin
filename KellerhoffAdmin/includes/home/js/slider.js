    ...
    if (listSlider != null) {
        ...
        for (var i = 0; i < listSlider.length; i++) {
            ...
            if (listSlider[i].hsl_tipo == 1) {
                ...
                strHtml += '<a class="btn_slide pdfVerMas" onclick="onclickVerMasPdf(' + i + '); return false;" href="../../servicios/descargarArchivo.aspx?t=catalogo&n=' + listSlider[i].hsl_NombreRecursoDoc + '" target="_blank">ver más</a>';
                //href="../../servicios/descargarArchivo.aspx?t=' + 'ofertaspdf' + '&n='
            }
...
function mostrarPdf() {
    if (indexSliderPdf != null) {
       // window.open('../../archivos/catalogo/' + listSlider[indexSliderPdf].hsl_NombreRecursoDoc, '_blank');//_parent
        window.open('../../servicios/descargarArchivo.aspx?t=catalogo&n=' + listSlider[indexSliderPdf].hsl_NombreRecursoDoc, '_blank');//_parent
