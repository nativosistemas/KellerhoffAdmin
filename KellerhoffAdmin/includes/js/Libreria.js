    ...
    if (pValor.length > 4) {
        ...
        switch (tipo) {
            ...
            case 'OSC':
                ...
                break;
            case 'OS ':
                resultado = '<div class="txt_link_doc"><a href="' + 'Documento.aspx?t=' + 'OSC' + '&id=' + 'X' + nro + '" >' + pValor + '</a></div>';
                break;
            default:
                break;
        }
...
function MostrarMensajePopUp() {
    ...
    if (listaPopUp != null && listaPopUp.length > 0 && listaPopUp[0].arc_nombre != null) {
        ...
        $('#idImgPopUp').attr('src', '../../../servicios/thumbnail.aspx?r=' + 'popup' + '&n=' + listaPopUp[0].arc_nombre + '&an=' + String(459) + '&al=' + String(650));
